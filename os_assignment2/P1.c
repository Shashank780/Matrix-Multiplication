...
int main(int argc, char *argv[])  {
    ...
    outputid = shmget((key_t)1000, 1024, IPC_CREAT|0666); // 1024 chars only
    dimensionsid = shmget((key_t)1001, 3*sizeof(long long), IPC_CREAT|0666); // 1024 chars only


    matrix1id = shmget((key_t)2041, n1*m1*sizeof(long long), IPC_CREAT|0666);
    matrix1_row_flagid = shmget((key_t)2042, n1*sizeof(int), IPC_CREAT|0666);

    matrix2id = shmget((key_t)3041, n2*m2*sizeof(long long), IPC_CREAT|0666);
    matrix2_column_flagid = shmget((key_t)3042, m2*sizeof(int), IPC_CREAT|0666);
